    ...
    Item
    {
        ...
        [
                State
                {
                    ...
                    PropertyChanges{ target: modeLabel; text: qsTr("Current Mode: stopped") }
                ...
                State
                {
                    ...
                    PropertyChanges{ target: modeLabel; text: qsTr("Current Mode: single") }
                ...
                State
                {
                    ...
                    PropertyChanges{ target: modeLabel; text: qsTr("Current Mode: running") }
